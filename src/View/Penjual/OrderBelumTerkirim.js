                    ...
                    <ModalBody>
                        <div className="form-group">
                            ...
                            <Form.Group controlId="dikirim">
                                  <Form.Check value="dikirim" id ="dikirim" controlId="dikirim" type="checkbox" label="dikirim" onClick={this.yesnoCheck} onChange={this.handleChange} value={form?form.Status:''} />
                              </Form.Group>
                            </Form>
